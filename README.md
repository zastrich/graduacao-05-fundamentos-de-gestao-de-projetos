...
![Canvas de Visão](./src/trabalho-final/pratico/lean-vision-canvas.png)

#### Roadmap Estratégico
Visão temporal das entregas divididas em fases de maturidade do produto.
![Roadmap Visual](./src/trabalho-final/pratico/roadmap.png)

#### Matriz de Riscos
Análise de probabilidade e impacto para os principais desafios do projeto.
![Matriz de Riscos](./src/trabalho-final/pratico/matriz-de-risco-detalhada.png)
